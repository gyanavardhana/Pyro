...
const Leaderboard = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(`${import.meta.env.VITE_APP_URL}leaderboard/getleaderboard`, {
          headers: {
  ...
  return (
    <>
      ...
      <h2 className="text-center pt-24 text-4xl md:text-5xl font-bold text-green-900 mb-6">Leaderboard</h2>
